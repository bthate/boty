...
class Dispatch_Handler(RequestHandler):
    ...
    def post(self):
        ...
        except google.appengine.runtime.DeadlineExceededError, ex: pass
...
application = WSGIApplication([('/dispatch', Dispatch_Handler),
                               ('/dispatch', Dispatch_Handler) ], debug=True)
