    ...
    def post(self, url=None):
        try:
            ...
            if "disconnected" in url: 
                ...
                if client_id not in chan.data.webchannels: chan.data.webchannels.insert(0, client_id) ; chan.save() ; logging.warn("added channel %s" % client_id) ; return
            elif "error" in url:
